class EndlessRunner {
  ...
  //       for (
  //         let x = -blockWidth;
  //         x < this.canvas.width + blockWidth;
  //         x += blockWidth
  //       ) {
  ...
  //         function rand(n) {
  //           return (Math.sin(seed + n) + 1) * 0.5;
  //         }

  //         // Subtle color variation for each block
  //         const shade =
  //           230 +
  //           Math.floor(Math.sin(x * 0.13 + y * 0.21) * 10) +
  //           Math.floor(rand(1) * 8);
  ...
  //           this.ctx.beginPath();
  //           this.ctx.arc(
  //             drawX + blockWidth * rand(18),
  //             y + blockHeight * rand(19),
  //             10 + rand(20) * 8,
  //             0,
  //             Math.PI * 2
  //           );
  ...
  //           const flicker =
  //             0.7 + Math.sin(Date.now() * 0.02 + x * 0.1 + y * 0.2) * 0.3;
  //           this.ctx.save();
  ...
  //       if (sy < 0) sy = 10;
  //       if (sx < 0) sx = 10;
  //       if (sx + statueW > this.canvas.width)
  //         sx = this.canvas.width - statueW - 10;
  //       this.ctx.save();
  ...
  //     const torchPresenceSeed =
  //       Math.sin(wall.depth * 50 + wall.type * 25 + wall.width * 0.02) * 1000;
  //     if (Math.abs(torchPresenceSeed) % 1000 < 500) {
  //       // 50% chance for torches, but deterministic
  //       // Use deterministic positioning based on stable wall properties (not wall.x which moves)
  //       const torchSeed =
  //         Math.sin(wall.depth * 100 + wall.type * 50 + wall.width * 0.01) *
  //         1000;
  //       const torchX =
  //         wx + wall.width * (0.3 + ((Math.abs(torchSeed) % 1000) / 1000) * 0.4);
  ...
  //         // Torch flame with flicker
  //         const flicker =
  //           Math.sin(Date.now() * 0.01 + wall.depth * 10 + wall.type) * 0.3 +
  //           0.7;
  ...
  //     const glowPresenceSeed =
  //       Math.cos(wall.depth * 75 + wall.type * 30 + wall.width * 0.015) * 1000;
  //     if (Math.abs(glowPresenceSeed) % 1000 < 300 && this.level === 2) {
  //       // 30% chance for mystical runes
  //       const glowSeed =
  //         Math.cos(wall.depth * 200 + wall.type * 75 + wall.width * 0.005) *
  //         1000;
  //       const glowX =
  //         wx + wall.width * 0.5 + ((Math.abs(glowSeed) % 200) - 100) * 0.5;
  ...
  //         0,
  //         `rgba(212, 175, 55, ${alpha * pulseIntensity * 0.4})`
  //       );
  //       glowGradient.addColorStop(
  //         0.5,
  //         `rgba(255, 140, 0, ${alpha * pulseIntensity * 0.3})`
  //       );
  ...
  //       this.ctx.fillStyle = `rgba(255, 215, 0, ${
  //         alpha * pulseIntensity * 0.5
  //       })`;
